...
class Livre
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['user:favoris','livre:read', 'sous_categorie:read', 'livresimple:read', 'livre:details','exemplaire_livre:read','reservation:read','reservation:details'])]
    private ?int $id = null;
    ...
    #[Groups(['livre:read', 'sous_categorie:read', 'livre:details','exemplaire_livre:read'])]
    ...
    #[ORM\ManyToOne(inversedBy: 'livres')]
    #[ORM\JoinColumn(nullable: false)]
    #[Groups(['livre:read','livresimple:read', 'livre:details','exemplaire_livre:read'])]
